...
/*
3. Dado el grafo de la Figura 2, encontrar el camino más corto desde el vértice G al resto de
vértices (Se han de seguir los pasos del algoritmo de Dijkstra, e incluir la secuencia de
vértices que forman el camino)
 */
...
public class algoritmoDijkstra
{
    ...
    public algoritmoDijkstra(int nver)
    {
    ...
    public void leetecl(int nver)
    {
        ...
        {
            System.out.print("\n Cuantos vertices estan conectados al vertice "+(i+1)+" :");
            nady=valor.nextInt();
            while(nady !=0)
            {
                System.out.print("\n   Da vertice conectados al vertice "+(i+1)+": ");
                ady=valor.nextInt()-1;
    ...
    public static void main(String args[])
    {
        ...
        algoritmoDijkstra grafo=new algoritmoDijkstra(nver);
